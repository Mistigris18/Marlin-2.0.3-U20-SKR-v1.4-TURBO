...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LED_CONTROL_MENU
    ...
    #define LED_COLOR_PRESETS                 // Enable the Preset Color menu option
      ...
      #define LED_USER_PRESET_BRIGHTNESS 130  // User defined intensity
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN      P1_00 // Pin to detect power loss
 ...
 */
  ...
  //#define TOOLCHANGE_FILAMENT_SWAP
    ...
    #define TOOLCHANGE_FIL_SWAP_LENGTH          90  // (mm)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      395  // (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE      25  // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
...
//#define WIFISUPPORT
  ...
  #define WIFI_SSID "livebox-0840"
  #define WIFI_PWD  "iVxC92Y3juvuD22Gpc"
